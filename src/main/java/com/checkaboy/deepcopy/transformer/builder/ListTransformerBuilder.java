...
public class ListTransformerBuilder<SV, TV>
    ...
    private ICollectionFiller<List<SV>, SV, List<TV>, TV> collectionFiller = (cache, source, target) -> {
    };

    protected ListTransformerBuilder(Class<SV> sourceType, Class<TV> targetType) {
